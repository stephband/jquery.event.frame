...
d=null},0)}}function i(c,a){for(var b=e[a].array,d=b.length;d--;)if(b[d]===c){b.splice(d,1);break}if(b.length===0){e[a].stop();delete e[a]}}var e={};f.event.special.frame={setup:function(c,a){var b=a.length;if(b)for(;b--;)h(this,a[b],c&&c.frameDuration);else h(this,0,c&&c.frameDuration)},teardown:function(c){var a=c.length;if(a)for(;a--;)i(this,c[a]);else for(var b in e)i(this,b)},handler:function(){var m=(d.event.dispatch)?'dispatch':'handle';d.event[m].apply(this,arguments)}}})(jQuery);
